...
const TemplateDetailAv = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const getItem = data?.data?.templateByTemplateID?.items[0];
      console.log(getItem);
      setData(getItem);
      const imagex = getItem.image;
      const imgx = getItem.image1;
      const url = await Storage.get(imagex);
      const url2 = await Storage.get(imgx);
      setImage(url);
      setImg(url2);
      console.log(url2);
    };
        ...
        <Container>
          <Left>
            ...
            <Div>
              ...
              <Input2 value={data.templatename} />
            </Div>
            {/* <Div>
            ...
            <Div2>
              ...
              <Input3 value={data.templatedetail} />
            </Div2>
          </Left>
          <Right>
            <Button2
              to={`/admin/${id}/panel/editbusiness/template/${templateId}/edit/`}
            >
              <FaUserEdit size="20" />
              Edit Template
            </Button2>
...
export default TemplateDetailAv;
